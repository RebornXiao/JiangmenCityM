...
import com.liqi.R;
import com.liqi.event.NaviEvent;
...
//		 BNOuterLogUtil.setLogSwitcher(true);
	...
	@Subscribe
	public void onMainTread(NaviEvent event){
		finish();
	}
...
//            showToastMsg("TTSPlayStateListener : TTS play start");
	...
	private void routeplanToNavi(CoordinateType coType) {
		...
		switch (coType) {
			...
			case BD09LL: {
				sNode = new BNRoutePlanNode(app.longitudeNaviStart, app.latitudeNaviStart, app.addressNaviEnd, null, coType);
				eNode = new BNRoutePlanNode(app.longitudeNaviEnd, app.latitudeNaviEnd, app.addressNaviEnd, null, coType);
				break;
			}
			default:
				;
